<div>
    <header class="bg-white h-20 fixed top-0 w-full z-10 ">
        <nav class="flex justify-between items-center w-[92%] mx-auto pt-5">
            <div>
                <img style="width: 10rem" class="w-16 cursor-pointer" src="{{ asset('img/logo-libtel.svg') }}"
                    alt="Logo Libtel">
            </div>
            <div
            ...
            @guest
                <div class="flex items-center gap-6">
                    <a href="/login"
                        class="bg-[brown] text-white px-5 py-2 rounded-lg hover:bg-[brown-dark] flex items-center">
            ...
            @auth
              ...
              <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full md:border before:-top-5 before:start-0 before:w-full before:h-5">
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" wire:navigate href="/my-">
                  My Book
                </a>
