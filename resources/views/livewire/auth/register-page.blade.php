        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <div class="p-4 sm:p-7">
            ...
            <form wire:submit.prevent='save'>
                <div>
                    <label for="full_name" class="block text-sm mb-2 dark:text-white">Full name</label>
                    <div class="relative">
                      <input type="text" id="full_name" wire:model="full_name" class="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="full_name-error">
                      @error('full_name')
                    ...
                    @error('full_name')
                    <p class="text-xs text-red-600 mt-2" id="full_name-error">{{ $message }}</p>
                    @enderror
                </div>
              <div class="grid gap-y-4 grid-cols-1 sm:grid-cols-2">
                <!-- Form Group -->
                <div>
              ...
              <button style="margin-top: 2rem" type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-brown text-white hover:bg-brown-dark disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Sign up</button>
            </form>
            <!-- End Form -->
          </div>
        </div>
